...
: ${AMENT_CURRENT_PREFIX:="/workspace/aerial_ws/ros2_ws/install/autopilot_interface"}
...
ament_append_value AMENT_ENVIRONMENT_HOOKS "$AMENT_CURRENT_PREFIX/share/autopilot_interface/environment/ament_prefix_path.sh"
ament_append_value AMENT_ENVIRONMENT_HOOKS "$AMENT_CURRENT_PREFIX/share/autopilot_interface/environment/path.sh"
