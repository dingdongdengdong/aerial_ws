...
static const _NodeHealth_type_support_symbol_names_t _NodeHealth_message_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, pegasus_msgs, msg, NodeHealth)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_c, pegasus_msgs, msg, NodeHealth)),
  }
};
...
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_c, pegasus_msgs, msg, NodeHealth)() {
  return &::pegasus_msgs::msg::rosidl_typesupport_c::NodeHealth_message_type_support_handle;
}
