...
static const _ZoneInfo_type_support_symbol_names_t _ZoneInfo_message_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, pegasus_msgs, msg, ZoneInfo)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_cpp, pegasus_msgs, msg, ZoneInfo)),
  }
};
...
{
  return &::pegasus_msgs::msg::rosidl_typesupport_cpp::ZoneInfo_message_type_support_handle;
}
...
ROSIDL_TYPESUPPORT_CPP_PUBLIC
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_cpp, pegasus_msgs, msg, ZoneInfo)() {
  return get_message_type_support_handle<pegasus_msgs::msg::ZoneInfo>();
}
