...
static const _SetReposition_Request_type_support_symbol_names_t _SetReposition_Request_message_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, autopilot_interface_msgs, srv, SetReposition_Request)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_c, autopilot_interface_msgs, srv, SetReposition_Request)),
  }
};
...
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_c, autopilot_interface_msgs, srv, SetReposition_Request)() {
  return &::autopilot_interface_msgs::srv::rosidl_typesupport_c::SetReposition_Request_message_type_support_handle;
}
...
static const _SetReposition_Response_type_support_symbol_names_t _SetReposition_Response_message_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, autopilot_interface_msgs, srv, SetReposition_Response)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_c, autopilot_interface_msgs, srv, SetReposition_Response)),
  }
};
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_c, autopilot_interface_msgs, srv, SetReposition_Response)() {
  return &::autopilot_interface_msgs::srv::rosidl_typesupport_c::SetReposition_Response_message_type_support_handle;
}
...
static const _SetReposition_type_support_symbol_names_t _SetReposition_service_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__SERVICE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, autopilot_interface_msgs, srv, SetReposition)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__SERVICE_SYMBOL_NAME(rosidl_typesupport_introspection_c, autopilot_interface_msgs, srv, SetReposition)),
  }
};
...
ROSIDL_TYPESUPPORT_INTERFACE__SERVICE_SYMBOL_NAME(rosidl_typesupport_c, autopilot_interface_msgs, srv, SetReposition)() {
  return &::autopilot_interface_msgs::srv::rosidl_typesupport_c::SetReposition_service_type_support_handle;
}
