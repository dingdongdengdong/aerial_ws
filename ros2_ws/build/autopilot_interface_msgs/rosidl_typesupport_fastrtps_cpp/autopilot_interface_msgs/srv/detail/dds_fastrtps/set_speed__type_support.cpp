...
#include "autopilot_interface_msgs/srv/detail/set_speed__rosidl_typesupport_fastrtps_cpp.hpp"
...
cdr_serialize(
  const autopilot_interface_msgs::srv::SetSpeed_Request & ros_message,
...
cdr_deserialize(
  eprosima::fastcdr::Cdr & cdr,
  autopilot_interface_msgs::srv::SetSpeed_Request & ros_message)
{
  // Member: speed
  cdr >> ros_message.speed;
  ...
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    using DataType = autopilot_interface_msgs::srv::SetSpeed_Request;
    is_plain =
      (
...
{
  auto typed_message =
    static_cast<const autopilot_interface_msgs::srv::SetSpeed_Request *>(
    untyped_ros_message);
...
{
  auto typed_message =
    static_cast<autopilot_interface_msgs::srv::SetSpeed_Request *>(
    untyped_ros_message);
...
{
  return &autopilot_interface_msgs::srv::typesupport_fastrtps_cpp::_SetSpeed_Request__handle;
}
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, autopilot_interface_msgs, srv, SetSpeed_Request)() {
  return &autopilot_interface_msgs::srv::typesupport_fastrtps_cpp::_SetSpeed_Request__handle;
}
...
ROSIDL_TYPESUPPORT_FASTRTPS_CPP_PUBLIC_autopilot_interface_msgs
cdr_serialize(
  const autopilot_interface_msgs::srv::SetSpeed_Response & ros_message,
  eprosima::fastcdr::Cdr & cdr)
{
  // Member: success
...
cdr_deserialize(
  eprosima::fastcdr::Cdr & cdr,
  autopilot_interface_msgs::srv::SetSpeed_Response & ros_message)
{
  // Member: success
  {
    uint8_t tmp;
  ...
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    // We still need to check that the in-memory alignment
    // is the same as the CDR mandated alignment.
    using DataType = autopilot_interface_msgs::srv::SetSpeed_Response;
    is_plain =
      (
...
{
  auto typed_message =
    static_cast<const autopilot_interface_msgs::srv::SetSpeed_Response *>(
    untyped_ros_message);
  return cdr_serialize(*typed_message, cdr);
}
...
{
  auto typed_message =
    static_cast<autopilot_interface_msgs::srv::SetSpeed_Response *>(
    untyped_ros_message);
  return cdr_deserialize(cdr, *typed_message);
}
...
{
  return &autopilot_interface_msgs::srv::typesupport_fastrtps_cpp::_SetSpeed_Response__handle;
}
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, autopilot_interface_msgs, srv, SetSpeed_Response)() {
  return &autopilot_interface_msgs::srv::typesupport_fastrtps_cpp::_SetSpeed_Response__handle;
}
...
{
  return &autopilot_interface_msgs::srv::typesupport_fastrtps_cpp::_SetSpeed__handle;
}
...
const rosidl_service_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__SERVICE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, autopilot_interface_msgs, srv, SetSpeed)() {
  return &autopilot_interface_msgs::srv::typesupport_fastrtps_cpp::_SetSpeed__handle;
}
