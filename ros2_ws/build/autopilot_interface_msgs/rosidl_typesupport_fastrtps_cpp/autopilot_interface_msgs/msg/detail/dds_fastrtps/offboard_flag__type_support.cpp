...
#include "autopilot_interface_msgs/msg/detail/offboard_flag__rosidl_typesupport_fastrtps_cpp.hpp"
  ...
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    using DataType = autopilot_interface_msgs::msg::OffboardFlag;
    is_plain =
      (
...
{
  auto typed_message =
    static_cast<const autopilot_interface_msgs::msg::OffboardFlag *>(
    untyped_ros_message);
...
{
  auto typed_message =
    static_cast<autopilot_interface_msgs::msg::OffboardFlag *>(
    untyped_ros_message);
  return cdr_deserialize(cdr, *typed_message);
}

static uint32_t _OffboardFlag__get_serialized_size(
  const void * untyped_ros_message)
{
  auto typed_message =
    static_cast<const autopilot_interface_msgs::msg::OffboardFlag *>(
...
static size_t _OffboardFlag__max_serialized_size(char & bounds_info)
{
  ...
  ret_val = max_serialized_size_OffboardFlag(full_bounded, is_plain, 0);
...
static message_type_support_callbacks_t _OffboardFlag__callbacks = {
...
static rosidl_message_type_support_t _OffboardFlag__handle = {
  rosidl_typesupport_fastrtps_cpp::typesupport_identifier,
  &_OffboardFlag__callbacks,
...
{
  return &autopilot_interface_msgs::msg::typesupport_fastrtps_cpp::_OffboardFlag__handle;
}
