...
static const _OffboardFlag_type_support_symbol_names_t _OffboardFlag_message_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, autopilot_interface_msgs, msg, OffboardFlag)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_cpp, autopilot_interface_msgs, msg, OffboardFlag)),
  }
};
...
{
  return &::autopilot_interface_msgs::msg::rosidl_typesupport_cpp::OffboardFlag_message_type_support_handle;
}
...
ROSIDL_TYPESUPPORT_CPP_PUBLIC
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_cpp, autopilot_interface_msgs, msg, OffboardFlag)() {
  return get_message_type_support_handle<autopilot_interface_msgs::msg::OffboardFlag>();
}
