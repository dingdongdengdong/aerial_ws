...
class Metaclass_SetSpeed(type):
    ...
    def __import_type_support__(cls):
        try:
            ...
            import traceback
            logger = logging.getLogger(
                'autopilot_interface_msgs.srv.SetSpeed')
            logger.debug(
                'Failed to import needed modules for type support:\n' +
                traceback.format_exc())
        else:
            ...
            from autopilot_interface_msgs.srv import _set_speed
...
class SetSpeed(metaclass=Metaclass_SetSpeed):
    from autopilot_interface_msgs.srv._set_speed import SetSpeed_Request as Request
    from autopilot_interface_msgs.srv._set_speed import SetSpeed_Response as Response
